...
// func TestLimitsChecker_ExceedsLimits(t *testing.T) {
...
// 			}
// 			store, err := newStatsStore(cfg.ActiveWindow, cfg.RateWindow, cfg.BucketSize, cfg.NumPartitions, reg)
...
// 			}
// 			m.clock = clock
// 			checker := newLimitsChecker(
// 				&limits,
// 				store,
// 				newProducer(&mockKafka{}, "test", cfg.NumPartitions, "", log.NewNopLogger(), reg),
// 				m,
// 				cfg.NumPartitions,
// 				log.NewNopLogger(),
// 				reg,
...
// 			resp, err := checker.ExceedsLimits(context.Background(), test.request)
// 			require.NoError(t, err)
// 			require.Equal(t, test.expected, resp)

// 			actualEntries := 0
// 			store.IterTenant(test.tenant, func(_ string, _ int32, _ streamStats) {
// 				actualEntries++
// 			})
